...
/**
 * Author/Date: venjerLu / 2016/12/13 14:47
...
public class GridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridItemDecoration(int gridSpacingPx, int gridSize, boolean needLeftSpacing) {
        mSizeGridSpacingPx = gridSpacingPx;
        mGridSize = gridSize;
        this.mNeedLeftSpacing = needLeftSpacing;
    }
