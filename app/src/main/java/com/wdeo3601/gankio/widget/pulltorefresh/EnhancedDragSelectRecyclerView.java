...
public class EnhancedDragSelectRecyclerView extends FrameLayout implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public EnhancedDragSelectRecyclerView(Context context) {
        super(context);
        setupView();
    }

    public EnhancedDragSelectRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setupView();
    }

    public EnhancedDragSelectRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                adapter.onLoadMoreStateChanged(false);
    ...
    public RecyclerView.ViewHolder findViewHolderForLayoutPosition(int posotion) {
        return mRecyclerView.findViewHolderForLayoutPosition(posotion);
    }
