...
public class FooterLoadMoreViewProvider extends ItemViewProvider<Object, FooterLoadMoreViewProvider.ViewHolder> {
    @NonNull
    @Override
    protected ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        View root = inflater.inflate(R.layout.widget_pull_to_refresh_footer, parent, false);
