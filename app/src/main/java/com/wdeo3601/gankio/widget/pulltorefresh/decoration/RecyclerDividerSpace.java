...
/**
 * Created by wendong on 2017/6/2 0002.
 * Email:       wdeo3601@gmail.com
 * Description: RecyclerView GridLayoutManager 设置分割线 万能分割
 */

public class RecyclerDividerSpace extends RecyclerView.ItemDecoration {
    private int space;
    private int color = -1;
    ...
    public RecyclerDividerSpace(int space) {
        this.space = space;
    }

    public RecyclerDividerSpace(int space, int color) {
        this.space = space;
        this.color = color;
    ...
    public RecyclerDividerSpace(int space, int color, int type) {
        this.space = space;
        this.color = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public RecyclerDividerSpace(int space, Drawable mDivider) {
        this.space = space;
