...
//        setSpanSizeLookup(lookup);
        ...
        LinearSmoothScroller linearSmoothScroller =
                new LinearSmoothScroller(recyclerView.getContext()) {
                    ...
                    public PointF computeScrollVectorForPosition(int targetPosition) {
                        return BaseGridLayoutManager.this
    ...
    public void setSpeedSlow() {
        ...
        MILLISECONDS_PER_INCH = UIUtil.INSTANCE.getResources().getDisplayMetrics().density * 0.1f;
    }

    public void setSpeedFast() {
        MILLISECONDS_PER_INCH = UIUtil.INSTANCE.getResources().getDisplayMetrics().density * 0.03f;
    }
}
